...
class Config:
    ...
    sample_size: int = 10_000  # Added attribute
    fids_to_ensure: Optional[List[int]] = None  # Added attribute

    def __post_init__(self):
        # Create directories
        self.checkpoint_dir.mkdir(parents=True, exist_ok=True)
        self.model_dir.mkdir(parents=True, exist_ok=True)
        self.data_path.mkdir(parents=True, exist_ok=True)  # Ensure data_path exists
